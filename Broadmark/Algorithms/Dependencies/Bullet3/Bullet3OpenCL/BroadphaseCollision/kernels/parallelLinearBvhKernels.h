...
"   bool inside = false;\n"
"	inside = (aabb1->m_min.x >= aabb2->m_max.x && aabb1->m_max.x <= aabb2->m_min.x &&\n"
"				aabb1->m_min.y >= aabb2->m_max.y && aabb1->m_max.y <= aabb2->m_min.y &&\n"
"				aabb1->m_min.z >= aabb2->m_max.z && aabb1->m_max.z <= aabb2->m_min.z) ? true : inside;\n"
"\n"	
"	bool endpoint = true;\n"
"	endpoint = (aabb1->m_min.x == aabb2->m_max.x || aabb1->m_min.x == aabb2->m_min.x\n"
"	|| aabb1->m_max.x == aabb2->m_min.x || aabb1->m_max.x == aabb2->m_max.x) ? endpoint : false;\n"
"	endpoint = (aabb1->m_min.y == aabb2->m_max.y || aabb1->m_min.y == aabb2->m_min.y\n"
"	|| aabb1->m_max.y == aabb2->m_min.y || aabb1->m_max.y == aabb2->m_max.y) ? endpoint : false;\n"
...
"				\n"
"               bool collides = true;\n"
"//               if(rigidAabbs[queryRigidIndex].m_collisionFilterGroup == 2)\n"
"//              printf(\"%i %i\", rigidAabbs[queryRigidIndex].m_collisionFilterGroup, rigidAabbs[bvhRigidIndex].m_collisionFilterMask);\n"
"				collides = (rigidAabbs[queryRigidIndex].m_collisionFilterGroup & rigidAabbs[bvhRigidIndex].m_collisionFilterMask) != 0;\n"
"               if (collides)\n"
"               {\n"
